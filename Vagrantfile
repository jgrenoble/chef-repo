...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jgrenoble-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jesse-grenoble"
  #   chef.validation_client_name = "jesse-grenoble-validator"
  #   chef.validation_key_path = ".chef/jesse-grenoble-validator.pem"
  # end
end
